...
<!--                 
                <form action="<?= base_url('/daerah/index')?>" method="POST" class="flex mt-2">
                    
                    <input type="text" type="search" placeholder="Cari Nama Daerah" name="keyword" class="py-2 px-4 focus:ring focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
