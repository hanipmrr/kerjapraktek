                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:block sm:ml-6 w-full flex">
                        <div class="flex space-x-4 justify-end">
                            ...
                            <a href="<?= base_url('provinsi') ?>" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium uppercase">Lokasi</a>

                            <?php if (isset($_SESSION['username'])) : ?>
                                <a href="<?= base_url('auth/') ?>logout" class="text-white hover:bg-red-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium bg-red-600 uppercase">Logout</a>
                            <?php else : ?>
